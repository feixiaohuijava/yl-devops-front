<template>
  <div class="main">
    <div class="wrapper wrapper-content">
      <d-table url="/api/cmdb/kubernetesingress/" ref="brandList" v-if="!showDetail" :conditionForm="condition">
        ...
        <template slot="column">
          ...
          <el-table-column label="ingress_host">
            <template slot-scope="scope">
              {{ scope.row.ingress_host }}
            </template>
          </el-table-column>
          <el-table-column label="ingress_http_path">
            <template slot-scope="scope">
              {{ scope.row.ingress_http_path }}
            </template>
          </el-table-column>
          <el-table-column label="ingress_http_service_name">
            <template slot-scope="scope">
              {{ scope.row.ingress_http_service_name }}
            </template>
          </el-table-column>
          <el-table-column label="ingress_http_service_port">
            <template slot-scope="scope">
              {{ scope.row.ingress_http_service_port }}
            </template>
          </el-table-column>
