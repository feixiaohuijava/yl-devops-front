<template>
  <div class="main">
    <div class="wrapper wrapper-content">
      <d-table url="/api/servicecom/alertmanagerviewset/" ref="brandList" v-if="!showDetail" :conditionForm="condition">
        ...
        <template slot="column">
          ...
          <el-table-column label="alertmanagerUrl">
            <template slot-scope="scope">
              {{ scope.row.alertmanagerUrl }}
            </template>
          </el-table-column>
        </template>
      </d-table>
