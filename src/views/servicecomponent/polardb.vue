<template>
  <div class="main">
    <div class="wrapper wrapper-content">
      <d-table url="/api/dbaudit/polardbviewset/" ref="brandList" v-if="!showDetail" :conditionForm="condition">
        ...
        <template slot="column">
          ...
          <el-table-column label="DBClusterId" width="200px">
            <template slot-scope="scope">
              <router-link class="document-btn" :to="{name:'db_polardbDatabase', params: {id: scope.row.id}}">{{
                scope.row.DBClusterId }}
              </router-link>
            </template>
          </el-table-column>
