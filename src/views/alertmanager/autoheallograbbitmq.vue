<template>
  <div class="main">
    <div class="wrapper wrapper-content">
      <d-table url="/api/webhookmanager/rabbitmqpublishviewset/" ref="brandList" v-if="!showDetail" :conditionForm="condition">
        ...
        <template slot="column">
          ...
          <el-table-column label="namespace" width="100px">
            <template slot-scope="scope">
              {{ scope.row.namespace }}
            </template>
          </el-table-column>
          <el-table-column label="src_queue_name" width="400px">
            <template slot-scope="scope">
              {{ scope.row.src_queue_name }}
            </template>
          </el-table-column>
          <el-table-column label="dst_queue_name" width="400px">
            <template slot-scope="scope">
              {{ scope.row.dst_queue_name }}
            </template>
          </el-table-column>
          <el-table-column label="publishFlag" width="100px">
            <template slot-scope="scope">
              {{ scope.row.publishFlag }}
            </template>
          </el-table-column>
          <el-table-column label="createdTime" width="180px">
            <template slot-scope="scope">
